  ...
  if (action === 'sitemap' && req.method === 'GET') {
    try {
      ...
      const staticUrls = [
        ...
        { loc: '/fiyat-hesaplama', priority: '0.7', freq: 'monthly' },
        { loc: '/basin', priority: '0.5', freq: 'monthly' },
        { loc: '/neden-biz', priority: '0.7', freq: 'monthly' },
        { loc: '/referans-programi', priority: '0.6', freq: 'monthly' },
        { loc: '/podcast-webinar', priority: '0.6', freq: 'weekly' },
        { loc: '/bulten-arsivi', priority: '0.6', freq: 'weekly' },
